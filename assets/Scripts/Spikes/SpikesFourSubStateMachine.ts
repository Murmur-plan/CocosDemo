...
export default class SpikesFourSubStateMachine extends SubStateMachine {
  constructor(fsm: StateMachine) {
    ...
    this.stateMachines.set(SPIKES_COUNT_ENUM.FOUR, new State(this.fsm, `${BASE_URL}/four`))
    this.stateMachines.set(SPIKES_COUNT_ENUM.FIVE, new State(this.fsm, `${BASE_URL}/five`))
  }
